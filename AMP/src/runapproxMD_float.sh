...
do     
       ...
       Source="/to/path/src/results/AMP_float.result1"
       ./Compress_float_approxiMedian $Path 500 500 100 >> $Source
...
do     
       ...
       Source="/to/path/src/results/AMP_float.result2"
       ./Compress_float_approxiMedian $Path 512 512 512 >> $Source
...
do     
       ...
       Source="/to/path/src/results/AMP_float.result3"
       ./Compress_float_approxiMedian $Path 1200 1200 98 >> $Source
...
do     
       ...
       Source="/to/path/src/results/AMP_float.result4"
       ./Compress_float_approxiMedian $Path 3600 1800 26 >> $Source
