...
do     
       ...
       Source="/to/path/src/results/rawCompress_float.result1"
...
do     
       ...
       Source="/to/path/src/results/rawCompress_float.result2"
...
do     
       ...
       Source="/to/path/src/results/rawCompress_float.result3"
       ./Compress_float $Path 1200 1200 98 >> $Source
...
do     
       ...
       Source="/to/path/src/results/rawCompress_float.result4"
       ./Compress_float $Path 3600 1800 26 >> $Source
